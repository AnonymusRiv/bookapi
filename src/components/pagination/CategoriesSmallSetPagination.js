...
function CategoriesSmallSetPagination({get_book_list_page, book_list, count, category_id}){
    ...
    const visitPage = (page) => {
      ...
      setCurrentPage(page);
      setActive(page);
      get_book_list_page(category_id, page)
    }
    ...
    const previous_number = () => {
      ...
      if (currentPage !== 1){
        ...
        get_book_list_page(category_id, currentPage-1)
      }
    };
